...
func (noopZeto) Lock(_ context.Context, _, _ string) (*ports.ZetoLockResult, error)  { return nil, errNoPaladin }
func (noopZeto) Unlock(_ context.Context, _ string) (string, error)                  { return "", errNoPaladin }
func (noopZeto) TransferLocked(_ context.Context, _, _, _ string) (string, error)    { return "", errNoPaladin }
func (noopZeto) Balance(_ context.Context, _ string) (string, error)                 { return "", errNoPaladin }
