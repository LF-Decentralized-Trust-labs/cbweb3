...
NEW_NODES=1
CONTAINER_PREFIX="${CONTAINER_PREFIX:-cbweb3-hub-besu}"
NETWORK_NAME="${NETWORK_NAME:-cbweb3_hub_besu_network}"
BASE_P2P_PORT="${BASE_P2P_PORT:-30310}"
BASE_RPC_PORT="${BASE_RPC_PORT:-8546}"
BOOT_RPC_PORT="${BOOT_RPC_PORT:-8545}"
DEBUG_MODE=""
