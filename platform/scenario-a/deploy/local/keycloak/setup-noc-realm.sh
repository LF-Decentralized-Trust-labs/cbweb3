...
if [[ -n "${CLIENT_EXISTS}" ]]; then
  ...
  ${KCADM} create clients -r "${NOC_REALM}" \
    ...
    -s "redirectUris=[\"http://localhost:5173/*\",\"http://localhost:5174/*\",\"http://localhost:5175/*\",\"http://localhost:5176/*\",\"http://localhost:5177/*\",\"http://localhost:5178/*\",\"http://localhost:5180/*\",\"http://localhost:5900/*\"]" \
    -s "webOrigins=[\"http://localhost:5173\",\"http://localhost:5174\",\"http://localhost:5175\",\"http://localhost:5176\",\"http://localhost:5177\",\"http://localhost:5178\",\"http://localhost:5180\",\"http://localhost:5900\"]"
