...
// DisclosureState enumerates the lifecycle states of an AML/CFT disclosure request.
...
// DisclosureRequest tracks a supervisor-initiated disclosure workflow (FR-034 / SC-023).
...
// The (request_id, signer_id) pair is unique — one signature per signer per request.
