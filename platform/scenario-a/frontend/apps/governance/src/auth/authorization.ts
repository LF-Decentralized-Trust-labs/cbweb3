 ...
 *
 * Deliberately NOT the same predicate as page access: widening the single portal gate
 * without per-route requirements would expose every governance page to an
 * Admission-only operator.
 */
...
/**
 * Default requirement. A page added without an explicit requirement stays closed to the
 * Admission profile rather than silently opening to it (FR-008).
 */
