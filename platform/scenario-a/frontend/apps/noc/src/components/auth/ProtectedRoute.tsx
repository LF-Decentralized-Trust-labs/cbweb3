...
import { hasNOCAccess } from "../../auth/authorization";
...
export function ProtectedRoute() {
  ...
  if (!initialized || status === "loading") {
    return <div className="p-6 text-sm text-muted-foreground">Checking NOC session...</div>;
  }
  ...
  if (!isAuthenticated || !hasNOCAccess(user)) {
