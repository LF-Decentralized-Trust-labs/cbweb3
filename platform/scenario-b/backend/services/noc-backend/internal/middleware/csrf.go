...
// This is a per-scenario copy of the api-gateway's CSRF guard (Constitution Principle I:
// scenarios do not share code). It is copied rather than reimplemented on purpose — the
// three properties commented below were each found in review on the gateway side, and a
