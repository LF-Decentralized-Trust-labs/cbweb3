...
// Pending participant, which cannot transact.
//
...
// participant to Pending and revert its in-flight locks/claims). For a wallet that
// is registered-but-Pending, it re-registers (harmless — same state) and verifies.
//
