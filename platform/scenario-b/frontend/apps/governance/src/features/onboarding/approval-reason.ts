 ...
 *
 * The message is the operator-facing copy, so the same words appear under the field, in the
 * disabled button's reason and in the refusal — a requirement described three different ways reads
