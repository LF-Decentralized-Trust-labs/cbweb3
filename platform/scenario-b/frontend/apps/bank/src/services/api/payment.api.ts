...
export const paymentApi = {
  registerDeposit: async (payload: RegisterDepositRequest): Promise<RegisterDepositResponse> => {
  ...
  requestEscrow: async (payload: RequestEscrowRequest): Promise<RequestEscrowResponse> => {
  ...
  requestRedeem: async (payload: RequestRedeemRequest): Promise<RequestRedeemResponse> => {
