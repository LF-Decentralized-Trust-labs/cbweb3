# Scenario B — Supervisor Portal User Manual
...
supervisors and regulators in **Scenario B — International Hub**: monitoring Hub
liquidity, reviewing the participant registry, inspecting audit records, and watching
stability indicators. In the current build every screen is populated with **sample
data** so the intended layout can be reviewed ahead of live integration.

| Actor | Portal | Role (intended) |
|---|---|---|
| Supervisor / Regulator | Supervisor Portal | Read-only monitoring, compliance oversight, audit review |

> The Scenario B Supervisor build is the same UI as Scenario A and shares the same
> R2-CR-8 limitation: mock data and a demo login.
...
![Screenshot: Scenario B — Supervisor login](../img/scenario-b/supervisor-login.png) <!-- TODO: capture screenshot -->

> **Sample data / demo login.** This sign-in does not perform real authentication.
> It will be replaced by the platform's production identity provider as part of the
> R2-CR-8 work.
...
![Screenshot: Scenario B — Supervisor Dashboard](../img/scenario-b/supervisor-dashboard.png) <!-- TODO: capture screenshot -->
...
Liquidity positions and pool balances across the Hub, intended to help a supervisor
spot imbalances.

![Screenshot: Scenario B — Liquidity Monitor](../img/scenario-b/supervisor-liquidity.png) <!-- TODO: capture screenshot -->
...
A searchable list of participating institutions with compliance status and
jurisdiction. The search box filters by institution, address, or jurisdiction.

![Screenshot: Scenario B — Compliance Registry](../img/scenario-b/supervisor-participants.png) <!-- TODO: capture screenshot -->

> **Sample data.** Not the live registry.
...
![Screenshot: Scenario B — Audit Vault](../img/scenario-b/supervisor-audit.png) <!-- TODO: capture screenshot -->

> **Sample data.** Entries and any decryption results are illustrative and must not
> be used as evidence.
...
Pool stability indicators and alerts intended to flag stressed pools.

![Screenshot: Scenario B — Stability Insights](../img/scenario-b/supervisor-stability.png) <!-- TODO: capture screenshot -->
...
> will be updated to remove the sample-data warnings and document the real behaviour
> of each screen.
